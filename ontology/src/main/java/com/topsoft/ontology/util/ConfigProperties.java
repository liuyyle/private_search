...
public class ConfigProperties extends Properties {
	...
	public static final String CONFIG_NAMR_BENCHMARK_KEYWORD_COUNT = "benchmark.keyword.count";
	public static final String CONFIG_NAMR_BENCHMARK_DOCUMENT_COUNT = "benchmark.document.count";
	public static final String CONFIG_NAMR_BENCHMARK_SOLR_HOST = "benchmark.solr.host";
	public static final String CONFIG_NAMR_BENCHMARK_SPREADSHEET_DIR = "benchmark.spreadsheet.dir";

	// config for networking
	public static final String FTP_LOGIN_PREFIX = "ftp.login.";
	public static final String CONFIG_NAMR_FTP_DATA_DIR = "ftp.data.dir";
